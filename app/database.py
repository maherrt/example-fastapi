...
#connection format        'postgresql://<username>:<password>@<ip-address/localhost>/<database_name>'
# SQLALCHEMY_DATABASE_URL  = 'postgresql://postgres:maramsen@localhost/fastapi'
